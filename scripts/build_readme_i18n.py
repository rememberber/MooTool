...
EN_MAP = [
    ...
    ("## 下载", "## Download"),
    ("- [MooTool Next Electron 1.1.2（推荐）](https://github.com/rememberber/MooTool/releases/tag/next-electron-v1.1.2)",
     "- [MooTool Next Electron 1.1.2 (recommended)](https://github.com/rememberber/MooTool/releases/tag/next-electron-v1.1.2)"),
