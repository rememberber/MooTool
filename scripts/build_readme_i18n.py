...
EN_MAP = [
    ...
    ("## 下载", "## Download"),
    ("- [MooTool Next Electron 1.0.7（推荐）](https://github.com/rememberber/MooTool/releases/tag/next-electron-v1.0.7)",
     "- [MooTool Next Electron 1.0.7 (recommended)](https://github.com/rememberber/MooTool/releases/tag/next-electron-v1.0.7)"),
