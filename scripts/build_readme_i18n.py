...
EN_MAP = [
    ...
    ("## 下载", "## Download"),
    ("- [MooTool Next Electron 1.0.3（推荐）](https://github.com/rememberber/MooTool/releases/tag/next-electron-v1.0.3)",
     "- [MooTool Next Electron 1.0.3 (recommended)](https://github.com/rememberber/MooTool/releases/tag/next-electron-v1.0.3)"),
