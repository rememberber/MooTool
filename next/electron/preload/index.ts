...
contextBridge.exposeInMainWorld('mootool', {
  ...
  pickScreenColor: (): Promise<string | null> => ipcRenderer.invoke('screen-color:pick'),
  getScreenColorOverlay: (): Promise<ScreenCaptureOverlayData | null> => ipcRenderer.invoke('screen-color:get-overlay'),
  confirmScreenColor: (color: string): Promise<void> => ipcRenderer.invoke('screen-color:confirm', color),
  cancelScreenColor: (): Promise<void> => ipcRenderer.invoke('screen-color:cancel'),
  consumePendingScreenColor: (): Promise<string | null> => ipcRenderer.invoke('screen-color:consume-pending'),
  ...
  revealJsonVaultEntry: (relativePath: string): Promise<void> => ipcRenderer.invoke('json-vault:reveal', relativePath),
  ...
  revealQuickNoteEntry: (relativePath: string): Promise<void> => ipcRenderer.invoke('quick-note:reveal', relativePath),
  ...
  onScreenColorPicked: (callback: (color: string) => void) => subscribe('screen-color:picked', callback),
