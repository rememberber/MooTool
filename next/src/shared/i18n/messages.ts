...
export const messages = {
  'zh-CN': {
    ...
    'app.detail.new': '新建',
    'app.detail.openProject': '打开项目',
    'app.detail.status': '当前状态',
    'app.detail.localMode': '本地模式',
    'app.detail.localModeDesc': '后续每个工具通过 preload 暴露安全 API，React 只负责界面和交互。',
    'json.title': 'JSON 工作台',
  ...
  'en-US': {
    ...
    'app.detail.new': 'New',
    'app.detail.openProject': 'Open project',
    'app.detail.status': 'Status',
    'app.detail.localMode': 'Local mode',
    'app.detail.localModeDesc': 'Each tool will expose safe preload APIs while React handles the interface.',
  ...
  'ja-JP': {
    ...
    'app.detail.new': '新規',
    'app.detail.openProject': 'プロジェクトを開く',
    'app.detail.status': '現在の状態',
    'app.detail.localMode': 'ローカルモード',
    'app.detail.localModeDesc': '各ツールは preload の安全な API を使い、React は UI と操作を担当します。',
