...
export const messages = {
  'zh-CN': {
    ...
    ,'image.cropHint': '拖拽框选区域；拖动选区可移动，拖动四角可缩放。'
    ,'image.fullCapture': '恢复全屏'
  ...
  'en-US': {
    ...
    ,'image.cropHint': 'Drag to select an area. Move the selection or resize it from the corners.'
    ,'image.fullCapture': 'Use full screen'
  ...
  'ja-JP': {
    ...
    ,'image.cropHint': 'ドラッグして範囲を選択します。選択範囲の移動や四隅でのサイズ変更ができます。'
    ,'image.fullCapture': '画面全体に戻す'
