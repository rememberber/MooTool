...
| public-get | （可选 httpbin，`MOOTOOL_HTTP_PUBLIC_SMOKE=1`） | `HttpEngineTest.optionalHttpBinPublicGetSmoke`（[DIFF-526](../diff/526-http-pdf-merge-smoke-p7-slice.md)，默认 CI 跳过） |
