...
| `164-compose-host-profile-item-tab-focus.png` | Compose 场景 Host `.host-profile` 方案行焦点环（`HostProfileItemCaptureTest`，[DIFF-569](../../diff/569-time-host-mcp-css-slice.md)，与 `133` 搜索框互补，非产品窗） |
...
| `173-compose-json-toolbar-import-tab-focus.png` | Compose 场景 F04 JSON 工具栏导入钮焦点环（`JsonToolbarImportCaptureTest`，[DIFF-578](../../diff/578-json-config-reformat-mcp-css-slice.md)，非产品窗） |
