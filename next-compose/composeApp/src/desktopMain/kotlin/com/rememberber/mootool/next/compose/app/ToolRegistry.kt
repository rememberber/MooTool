...
object ToolRegistry {
    val tools: List<ToolDefinition> = listOf(
        ...
        tool(
            ...
            "app.nav.quickNote",
            "✎",
            listOf("note", "memo", "markdown", "vault", "duplicate", "随手记", "笔记"),
        ...
        tool(
            ...
            "app.nav.textDiff",
            "⇄",
            listOf("diff", "compare", "whitespace", "myers", "patch", "history", "对比"),
            ToolStatus.Available,
        ),
        ...
        tool(
            ...
            ToolGroupId.Dev,
            "app.nav.ymlProperties",
            "☰",
            listOf("yaml", "yml", "properties", "snakeyaml", "convert", "validate", "配置"),
            ToolStatus.Available,
        ),
        ...
        tool(
            ...
            "app.nav.uaParse",
            "UA",
            listOf("ua", "user-agent", "browser", "chrome", "preset", "parse", "浏览器"),
            ToolStatus.Available,
        ),
        ...
        tool(
            ...
            "app.nav.regex",
            ".*",
            listOf("regex", "regular", "pattern", "test", "global", "正则", "捕获"),
            ToolStatus.Available,
        ),
        tool(
            ToolId.Cron,
            ...
            "app.nav.cron",
            "⏱",
            listOf("cron", "schedule", "quartz", "parse", "timezone", "favorite", "history", "定时"),
            ToolStatus.Available,
        ),
        ...
        tool(
            ...
            "app.nav.timeConvert",
            "◷",
            listOf("time", "timestamp", "unix", "timezone", "时间"),
            ToolStatus.Available,
        ),
        ...
        tool(
            ...
            "app.nav.translation",
            "文",
            listOf("translate", "word", "google", "bing", "debounce", "翻译"),
            ToolStatus.Available,
        ),
        tool(
            ToolId.Calculator,
            ...
            "app.nav.calculator",
            "=",
            listOf("calculator", "calc", "gcd", "lcm", "permutation", "计算", "进制"),
            ToolStatus.Available,
        ),
        tool(
            ToolId.ColorBoard,
            ...
            "app.nav.colorBoard",
            "◐",
            listOf("color", "palette", "hex", "rgb", "picker", "screen", "调色", "取色"),
            ToolStatus.Available,
        ),
        tool(
            ToolId.Image,
            ...
            "app.nav.image",
            "▣",
            listOf("image", "图片", "svg", "watermark", "compress", "base64", "clipboard", "截图"),
            ToolStatus.Available,
        ),
