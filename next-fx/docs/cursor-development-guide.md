...
当前为规格阶段，无 JavaFX 工程、可运行命令或已完成工具。产品独立意味着允许技术、功能和版本各自演进；冻结对齐基线用于这一轮开发，不构成永久同步义务。
...
本轮不是一次完成 P0–P7；但启动 P0 后应持续到其工作和验证完成，再交付下一轮明确入口。遇到本机无法提供的外部服务/系统权限，记录阻塞点并继续独立可做部分，不伪造成功。
