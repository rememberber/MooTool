...
export const reformatMessages = defineMessages({
  'zh-CN': {
    ...
    'action.copy': '复制', 'action.copied': '已复制', 'action.clear': '清空',
    'editor.pending': '待格式化内容', 'editor.stats': '{lines} 行 · {length} 字符',
    'editor.label': '{type} 格式化编辑器', 'notice.ready': '{type} 格式化器已就绪',
    'notice.formatted': '{type} 格式化完成', 'notice.loaded': '已载入 {file}', 'notice.cleared': '内容已清空',
  ...
  'en-US': {
    ...
    'action.copy': 'Copy', 'action.copied': 'Copied', 'action.clear': 'Clear',
    'editor.pending': 'Content to format', 'editor.stats': '{lines} lines · {length} characters',
    'editor.label': '{type} formatter editor', 'notice.ready': '{type} formatter is ready',
    'notice.formatted': '{type} formatting completed', 'notice.loaded': 'Loaded {file}', 'notice.cleared': 'Content cleared',
  ...
  'ja-JP': {
    ...
    'action.copy': 'コピー', 'action.copied': 'コピー済み', 'action.clear': 'クリア',
    'editor.pending': 'フォーマットする内容', 'editor.stats': '{lines} 行 · {length} 文字',
    'editor.label': '{type} フォーマッターエディター', 'notice.ready': '{type} フォーマッターの準備ができました',
    'notice.formatted': '{type} のフォーマットが完了しました', 'notice.loaded': '{file} を読み込みました', 'notice.cleared': '内容をクリアしました',
