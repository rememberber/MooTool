...
@main struct StandaloneTests {
    static func main() async {
        ...
        let tests: [(String, () throws -> Void)] = [
            ...
            ("Vault quick note attachments", suite.testVaultFilesystemMirrorsReferencedQuickNoteAttachments),
            ...
            ("Network diagnostics", suite.testNetworkDiagnosticsParsing),
            ("Vault Git checkpoint scheduler", suite.testVaultGitCheckpointSchedulerIdle),
            ("Vault Git continue guard", suite.testVaultGitContinueWithoutMergeReportsError),
            ("Digest vectors", suite.testKnownDigests),
            ("RSA crypto", suite.testRSACryptoRoundTrip),
            ("SM2 crypto", suite.testSM2ElectronFixtures),
