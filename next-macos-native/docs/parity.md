...
| 调色板 | 系统 ColorPicker、屏幕取色、HEX/RGB/HSL/SwiftUI；颜色/正则/Cron **收藏**（`toolFavorites`，与 Electron 收藏夹语义一致）；工具栏与结果栏主控件支持三语 | 全部色彩空间和 Electron 的配色功能；收藏夹分组 UI 较简；HEX 错误提示仍为中文 |
