...
final class CoreTests: XCTestCase {
    ...
    func testExtendedWorkspaceAndLegacyCompatibility() throws {
        ...
        XCTAssertEqual(patch.hideNavigationTitles, true)
        XCTAssertEqual(patch.showNavigationSeparators, false)
        ...
        XCTAssertTrue(imported.hideNavigationTitles)
        XCTAssertFalse(imported.showNavigationSeparators)
        ...
        let legacyRoot = FileManager.default.temporaryDirectory.appendingPathComponent("mootool-java-legacy-\(UUID().uuidString)")
        try FileManager.default.createDirectory(at: legacyRoot, withIntermediateDirectories: true)
        XCTAssertFalse(LegacyJavaDataPaths.hasLegacyInstall(at: legacyRoot))
