...
public class LanguageSelectDialog extends JDialog {
    ...
    public LanguageSelectDialog() {
        super(App.mainFrame, I18n.get("language.prompt.title"));
    ...
    private void $$$setupUI$$$() {
        ...
        panel3.setLayout(new GridLayoutManager(2, 1, new Insets(0, 16, 0, 16), -1, -1));
        contentPane.add(panel3, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        messageLabel = new JLabel();
        messageLabel.setText(" ");
        panel3.add(messageLabel, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
