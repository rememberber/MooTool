...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        Font headlineLabelFont = this.$$$getFont$$$(null, Font.BOLD, -1, headlineLabel.getFont());
        if (headlineLabelFont != null) headlineLabel.setFont(headlineLabelFont);
        headlineLabel.setText("字体太大或太小？");
        panel3.add(headlineLabel, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        hintLabel = new JLabel();
        hintLabel.setText("可以在\"菜单栏\"->\"外观\"中设置字体大小");
        panel3.add(hintLabel, new GridConstraints(2, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
