...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        aboutPanel.setLayout(new GridLayoutManager(8, 2, new Insets(0, 0, 0, 0), -1, -1));
        final JScrollPane scrollPane1 = new JScrollPane();
        aboutPanel.add(scrollPane1, new GridConstraints(0, 0, 8, 2, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_WANT_GROW, null, null, null, 0, false));
        final JPanel panel1 = new JPanel();
        panel1.setLayout(new GridLayoutManager(8, 2, new Insets(20, 20, 0, 0), -1, -1));
        ...
        panel3.setLayout(new GridLayoutManager(2, 1, new Insets(0, 0, 10, 0), -1, -1));
        ...
        panel3.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEmptyBorder(), "VERSION", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, this.$$$getFont$$$(null, Font.BOLD, -1, panel3.getFont())));
        final JLabel label3 = new JLabel();
        label3.setText("v1.0.0");
        panel3.add(label3, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final JLabel label4 = new JLabel();
        label4.setText("Check for update");
        ...
        label5.setText("GitHub：https://github.com/rememberber/MooTool");
        ...
        label6.setText("Gitee：https://gitee.com/zhoubochina/MooTool");
        ...
        label7.setText("https://github.com/rememberber/MooTool/issues");
        ...
        label8.setText("https://github.com/rememberber/MooTool/issues");
        ...
        label9.setText("https://github.com/rememberber/MooTool/issues");
