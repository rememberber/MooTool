...
public class AboutForm {
    ...
    private JLabel aboutLineDailyLabel;
    ...
    private void applyI18n() {
        ...
        I18nUiUtil.setText(aboutLineDailyLabel, "about.lineDaily");
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        panel3.setLayout(new GridLayoutManager(6, 1, new Insets(5, 3, 20, 0), -1, -1));
        ...
        aboutLine1Label = new JLabel();
        aboutLine1Label.setText("Hi! Thanks to use MooTool. \"Moo\" named from my daughter.");
        panel3.add(aboutLine1Label, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        aboutLineDailyLabel = new JLabel();
        aboutLineDailyLabel.setText("I keep building and improving MooTool to support my own day-to-day development work.");
        panel3.add(aboutLineDailyLabel, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        aboutLine2Label = new JLabel();
        aboutLine2Label.setText("Less Java developer use Swing building projects, but I still love to develop by it.");
        panel3.add(aboutLine2Label, new GridConstraints(2, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        aboutLine3Label = new JLabel();
        aboutLine3Label.setText("So every little free time, I had went towards the development.");
        panel3.add(aboutLine3Label, new GridConstraints(3, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        aboutLine4Label = new JLabel();
        aboutLine4Label.setText("I did some works finaly, although there are so many same on web page.");
        panel3.add(aboutLine4Label, new GridConstraints(4, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        aboutLine5Label = new JLabel();
        aboutLine5Label.setText("Hope you enjoy using it as much as I did building it.");
        panel3.add(aboutLine5Label, new GridConstraints(5, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        label3.setIcon(new ImageIcon(getClass().getResource("/icon/WePush-logo-64.png")));
        label3.setText("");
        wePushPanel.add(label3, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final JLabel label4 = new JLabel();
        label4.setText("WePush");
        wePushPanel.add(label4, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final JLabel label5 = new JLabel();
        label5.setText("专注批量推送的小而美的工具");
        wePushPanel.add(label5, new GridConstraints(2, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        label6.setText("MooInfo");
        mooInfoPanel.add(label6, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final JLabel label7 = new JLabel();
        label7.setText("Visual implementation of OSHI, to view information about the system and hardware");
        mooInfoPanel.add(label7, new GridConstraints(2, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        label8.setIcon(new ImageIcon(getClass().getResource("/icon/wx-zanshang.jpg")));
        label8.setText("");
        label8.setToolTipText("感谢您的鼓励和支持");
        ...
        label9.setText("Give me a grace");
