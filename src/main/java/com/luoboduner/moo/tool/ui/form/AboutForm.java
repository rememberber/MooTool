...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        aboutPanel.add(scrollPane1, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_WANT_GROW, null, null, null, 0, false));
        final JPanel panel1 = new JPanel();
        panel1.setLayout(new GridLayoutManager(9, 2, new Insets(20, 20, 0, 0), -1, -1));
        ...
        panel2.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEmptyBorder(), "MooTool", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, this.$$$getFont$$$(null, Font.BOLD, -1, panel2.getFont()), new Color(-3840)));
        ...
        panel3.setLayout(new GridLayoutManager(6, 1, new Insets(0, 0, 10, 0), -1, -1));
        ...
        label6.setText("I learned it before and loved it so much I felt this uncontrollable desire to design and develop for it.");
        ...
        label8.setText("I did it finaly, although there are so many same toolsets on webpage.");
        ...
        panel4.setLayout(new GridLayoutManager(2, 1, new Insets(0, 0, 10, 0), -1, -1));
        ...
        panel4.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEmptyBorder(), "GIT", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, this.$$$getFont$$$(null, Font.BOLD, -1, panel4.getFont())));
        final JLabel label10 = new JLabel();
        label10.setText("GitHub：https://github.com/rememberber/MooTool");
        ...
        label11.setText("Gitee：https://gitee.com/zhoubochina/MooTool");
        ...
        label12.setText("https://github.com/rememberber/MooTool/issues");
        ...
        panel7.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEmptyBorder(), "ENCOURAGE ME", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, this.$$$getFont$$$(null, Font.BOLD, -1, panel7.getFont())));
        ...
        panel8.setLayout(new GridLayoutManager(2, 1, new Insets(0, 0, 10, 0), -1, -1));
        panel1.add(panel8, new GridConstraints(6, 0, 1, 2, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        panel8.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEmptyBorder(), "VERSION", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, this.$$$getFont$$$(null, Font.BOLD, -1, panel8.getFont())));
        final JLabel label15 = new JLabel();
        label15.setText("v1.0.0");
        ...
        label16.setText("Check for update");
