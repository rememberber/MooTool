...
public class JsonBeautyForm {
    ...
    private JCheckBox 忽略键的大小写CheckBox;
    private JCheckBox key按照字母顺序排序CheckBox;
    private JCheckBox 检查重复keyCheckBox;
    private JButton JSON转XMLButton;
    private JButton XML转JSONButton;
    private JButton 格式化Button;
    private JTextField $TextField;
    private JButton 通过JSONPath取值Button;
    private JLabel moreCloseLabel;
    private JButton 可视化获取JSONPathButton;
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        menuPanel.setLayout(new GridLayoutManager(1, 13, new Insets(0, 0, 0, 0), -1, -1));
        ...
        moreButton.setText("");
        menuPanel.add(moreButton, new GridConstraints(0, 12, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        忽略键的大小写CheckBox = new JCheckBox();
        忽略键的大小写CheckBox.setText("忽略键的大小写");
        panel3.add(忽略键的大小写CheckBox, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        key按照字母顺序排序CheckBox = new JCheckBox();
        key按照字母顺序排序CheckBox.setText("Key按照字母顺序排序");
        panel3.add(key按照字母顺序排序CheckBox, new GridConstraints(2, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        检查重复keyCheckBox = new JCheckBox();
        检查重复keyCheckBox.setText("检查重复key");
        panel3.add(检查重复keyCheckBox, new GridConstraints(3, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        JSON转XMLButton = new JButton();
        JSON转XMLButton.setText("JSON转XML");
        panel3.add(JSON转XMLButton, new GridConstraints(6, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        XML转JSONButton = new JButton();
        XML转JSONButton.setText("XML转JSON");
        panel3.add(XML转JSONButton, new GridConstraints(7, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        格式化Button = new JButton();
        格式化Button.setText("格式化");
        panel3.add(格式化Button, new GridConstraints(4, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        通过JSONPath取值Button = new JButton();
        通过JSONPath取值Button.setText("通过JSON Path取值");
        panel3.add(通过JSONPath取值Button, new GridConstraints(10, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        可视化获取JSONPathButton = new JButton();
        可视化获取JSONPathButton.setText("可视化获取JSON Path");
        panel3.add(可视化获取JSONPathButton, new GridConstraints(11, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
    }
