...
/**
 * JSON Vault 的 Git 自动检查点提交。
 */
public final class JsonBeautyGitCheckpoint {
    ...
    private JsonBeautyGitCheckpoint() {
    }
    ...
    public static QuickNoteGitUtil.GitCommandResult runManualCheckpoint(String customMessage) {
        ...
        if (result.isSuccess()) {
            javax.swing.SwingUtilities.invokeLater(JsonBeautyForm::updateGitButtonStatus);
        }
        return result;
    }
