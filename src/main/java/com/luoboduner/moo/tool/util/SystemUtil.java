...
public class SystemUtil {
    ...
    public static final String CONFIG_HOME = USER_HOME + File.separator + ".MooTool";

    /**
     * 日志文件路径
     */
    public final static String LOG_DIR = USER_HOME + File.separator + ".MooTool" + File.separator + "logs" + File.separator;
